const { Given, When, Then } = require('cucumber');
  ...
  When (/^I click button "([^"]*)"$/, async function(button){
    return metricEditorPage.clickButton(button);
  });

  When (/^I click popup button "([^"]*)"$/, async function(button){
    return metricEditorPage.clickPopUpButton(button);
  });

  When (/^I choose metric editor function "([^"]*)"$/, async function(functionName){
  ...
  When (/^I choose function editor option "([^"]*)"$/, async function(option){
    return metricEditorPage.clearFormulaEditor(option);
  });

  When (/^I double click on "([^"]*)"$/, async function(functionName){
    await metricEditorPage.doubleClickFunction(functionName);
    return browser.sleep(500);
  });

  When(/^I provide input "([^"]*)"$/, async function(text){
  ...
  When(/^I name metric as "([^"]*)"$/, async function(provideMetricName){
