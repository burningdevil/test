...
Feature: 40_Edit_Content_Groups_recipients_in_app_editor
    1. add environment
    ...
    Scenario: 40_Edit_Content_Groups_recipients_in_app_editor
        When I select tab "Applications"
        When I click the application create entry
        When I input application name "WS_edit_content_groups_recipients_40"       
        ...
        When I switch to tab "Recipients" in content group editor
        When I add user "Tester 1" as recipients in content group editor
        Then check content group has user "Tester 1"
        ...
        When I switch to tab "Recipients" in content group editor
        Then check content group has user "MSTR User"
        Then check total objects in content group editor should be 1
        When I click "Cancel" button in content group editor
