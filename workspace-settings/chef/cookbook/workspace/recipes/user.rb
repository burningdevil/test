...
node.override[:extras][:project][:name] = "test-react-mud"
node.override[:extras][:project][:home] = "#{EXTRAS_WS_HOME}/Projects/microstrategy/DevOps/#{node[:extras][:project][:name]}"
