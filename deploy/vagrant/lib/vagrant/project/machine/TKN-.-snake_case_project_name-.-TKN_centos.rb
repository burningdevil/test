    ...
    module Machine
      class TKN-.-camel_case_project_name-.-TKNCentos < Base
        class Configuration < Vagrant::Project::Machine::Config::Base
          ...
          attr_config :TKN-.-snake_case_project_name-.-TKN_db_source
          ...
          def configure_this(provisioner)
            ...
            provisioner.configure{|chef|
              ...
              chef.json = Hash.new { |hash,key| hash[key] = Hash.new(&hash.default_proc) }
              chef.json[:TKN-.-snake_case_project_name-.-TKN][:db_source] = TKN-.-snake_case_project_name-.-TKN_db_source
            }
          end
