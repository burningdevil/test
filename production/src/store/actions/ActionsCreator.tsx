...
export const setCustomEmailNameError = (isNameError: boolean) => ({
  type: Actions.SET_CUSTOM_EMAIL_ERROR,
  data: isNameError
})

export const setShouldSendPreviewEmail = (shouldSend: boolean) => ({
  type: Actions.SET_SHOULD_SEND_PREVIEW_EMAIL,
  data: shouldSend
})
