    ...
    return (
        <Layout className="home-screen-home">
            ...
            <Layout.Sider className="home-screen-home-preview" width='274px'>
              <HomeScreenPreviewer deviceType={deviceType} platform={this.props.platform} toolbarDisabled={toolbarDisabled} toolbarHidden={toolbarHidden} icons={icons} isDossierHome={isDossierHome} handleDeviceTypeChange={this.props.handleDeviceTypeChange}/>
            </Layout.Sider>
        </Layout>
    );
  }
