    ...
    columns = [
        {
            ...
            render: (icon: [string, string, [boolean, string]]) => {
                return (
                    ...
                    <span style={ icon[2] && (this.props.toolbarHidden || !this.props.selectedLibraryIcons.includes(iconTypes.sidebar.key)) && this.isIconDisabled(icon[2][1]) ?  {opacity: 0.5} : {opacity: 1.0}}>
