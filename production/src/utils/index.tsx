...
export const LIBRARY_SERVER_SUPPORT_ENV_CONNECTIONS = '11.3.0930';
export const ISERVER_SUPPORT_AUTH_MODE = '11.3.0860';
export const ISERVER_SUPPORT_ALLOW_CONTENTS_IN_CONTENT_GROUPS = '11.3.0960';
export const LIBRARY_SUPPORT_ALLOW_CONTENTS_IN_CONTENT_GROUPS = '11.3.0960';
